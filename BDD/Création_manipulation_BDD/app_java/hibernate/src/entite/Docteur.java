...
public class Docteur implements java.io.Serializable {
    ...
    public Docteur(String matricule, String nomm, String prenomm, String niveau, BigDecimal nbrpatients) {
        this.matricule = matricule;
        this.nomm = nomm;
        this.prenomm = prenomm;
        this.niveau = niveau;
    ...
    public Docteur(String matricule, Specialite specialite, String nomm, String prenomm, String ville, String adresse, String niveau, BigDecimal nbrpatients, Set consultations, Set dossierpatients) {
        this.matricule = matricule;
